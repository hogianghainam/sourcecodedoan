...
namespace WebsiteBanHang.Controllers
{
    ...
    public class PhanQuyenController : Controller
    {
        ...
        public ActionResult PhanQuyen(int? id)
        {
            ...
            ViewBag.LoaiTVQuyen = db.LoaiThanhVien_Quyens.Where(n => n.MaLoaiTV == id);  //lấy ds loại của tv đó
            return View(ltv);
        }
        [HttpPost]
        public ActionResult PhanQuyen(int? MaLTV, IEnumerable<LoaiThanhVien_Quyen> lstPhanQuyen)
        {
            ...
            var lstDaPhanQuyen = db.LoaiThanhVien_Quyens.Where(n => n.MaLoaiTV == MaLTV);
            ...
            if(lstDaPhanQuyen != null)
            {
                foreach (var item in lstPhanQuyen)
                {
                    ...
                    db.LoaiThanhVien_Quyens.InsertOnSubmit(item);   //nếu đc check thì add data vào bảng phanquyen
                }
                db.SubmitChanges();
            }
