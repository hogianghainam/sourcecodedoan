    ...
    public class GioHangController : Controller
    {
        ...
        public ActionResult DatHang(KhachHang kh)
        {
            ...
            if(Session["TaiKhoan"] == null)     //nếu session rỗng thì là khách vãng lai
            {
                ...
                db.KhachHangs.InsertOnSubmit(khach);   //thêm vào bảng kh
                db.SubmitChanges();   //lưu vào db và tăng mãkh
            }
            else
            {
            ...
            ddh.DaHuy = false;
            ddh.DaXoa = false;
            db.DonDatHangs.InsertOnSubmit(ddh);    //thêm vào bảng dondathang giá trị ddh
            db.SubmitChanges();   //update bảng đơn đặt hàng, và tạo mã ddh dùng cho chitietddh
            ...
            db.SubmitChanges(); //update vào bảng chi tiết đơn đặt hàng
